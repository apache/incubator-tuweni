...
class BytesTest extends CommonBytesTests {
  ...
  void segments() {
    Bytes value =
        Bytes.fromHexString(
            "0x7b600035f660115760006000526001601ff35b60016000526001601ff3600052601c6000f3");
    Bytes32[] result = Bytes.segment(value);
    assertEquals(
        Bytes.fromHexString("0x7b600035f660115760006000526001601ff35b60016000526001601ff3600052"),
        result[0]);
    assertEquals(
        Bytes.fromHexString("0x601c6000f3000000000000000000000000000000000000000000000000000000"),
        result[1]);
  }
