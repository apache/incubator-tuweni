...
final class DefaultCompletableAsyncResult<T> implements CompletableAsyncResult<T> {
  ...
  public T get() throws CompletionException, InterruptedException {
    try {
      ...
      throw new RuntimeException(
          "Default timeout triggered for blocking call to AsyncResult::get()", ex);
    }
  }
  ...
  @Override
  public <U> AsyncResult<U> thenSchedule(
      Vertx vertx, Function<? super T, ? extends AsyncResult<U>> fn) {
  ...
  @Override
  public <U> AsyncResult<U> thenScheduleBlockingApply(
      Vertx vertx, Function<? super T, ? extends U> fn) {
    requireNonNull(vertx);
    requireNonNull(fn);
    CompletableAsyncResult<U> asyncResult = AsyncResult.incomplete();
    future.whenComplete(
