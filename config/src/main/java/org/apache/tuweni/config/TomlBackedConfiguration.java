...
final class TomlBackedConfiguration implements Configuration {
            ...
            err ->
                errors.add(
                    new ConfigurationError(
                        documentPosition(err.position()), err.getMessage(), err)));
    if (schema != null) {
  ...
  public List<String> getListOfString(String key) {
    return getList(
        key, "strings", TomlArray::containsStrings, (schema) -> schema::getDefaultListOfString);
  }
  ...
  public List<Integer> getListOfInteger(String key) {
    return getValue(
        ...
        keyPath -> {
          ...
          return IntStream.range(0, longList.size())
              .mapToObj(
                  i -> {
  ...
  public List<Double> getListOfDouble(String key) {
    return getList(
        key, "doubles", TomlArray::containsDoubles, schema -> schema::getDefaultListOfDouble);
  }

  @Override
  public List<Boolean> getListOfBoolean(String key) {
    return getList(
        key, "booleans", TomlArray::containsBooleans, schema -> schema::getDefaultListOfBoolean);
  }
  ...
  public List<Map<String, Object>> getListOfMap(String key) {
    ...
    return getValue(
        ...
        keyPath -> {
          ...
          @SuppressWarnings("unchecked")
          List<Map<String, Object>> typedList =
              (List<Map<String, Object>>) (List) deepToList(array);
          return typedList;
        },
  ...
  private <T> T getValue(
      String key, Function<List<String>, T> tomlGet, Function<String, T> defaultGet) {
    ...
    try {
      ...
      throw new InvalidConfigurationPropertyTypeException(
          inputPositionOf(keyPath), e.getMessage(), e);
    }
    if (value != null) {
      return value;
    }
