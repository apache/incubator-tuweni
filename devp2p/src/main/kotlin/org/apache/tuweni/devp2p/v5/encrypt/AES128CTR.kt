...
/**
 * Util dedicated for AES-CTR encoding with key size equal 16 bytes
 */
object AES128CTR {

  private const val ALGO_NAME: String = "AES"
  private const val CIPHER_NAME: String = "AES/CTR/NoPadding"
  private const val KEY_SIZE: Int = 128

  /**
   * AES128CTR encryption function
   *
  ...
  fun encrypt(privateKey: Bytes, nonce: Bytes, message: Bytes, additionalAuthenticatedData: Bytes): Bytes {
    ...
    cipher.init(
      ...
      IvParameterSpec(nonce.toArrayUnsafe())
    )
