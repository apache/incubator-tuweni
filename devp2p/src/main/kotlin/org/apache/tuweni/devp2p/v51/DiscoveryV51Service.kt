...
object DiscoveryService {
  ...
  fun open(
    ...
    return DefaultDiscoveryV51Service(
      bindAddress,
      bootstrapENRList,
      enrStorage,
      keyPair,
 ...
 */
interface DiscoveryV51Service : CoroutineScope {
...
internal class DefaultDiscoveryV51Service(
  ...
  companion object {
    ...
    private val logger = LoggerFactory.getLogger(DefaultDiscoveryV51Service::class.java)
  }
