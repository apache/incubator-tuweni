...
class OpcodeTest {
  companion object {
    ...
    private fun findBerlinTests(): Stream<Arguments> {
      return findTests("/certification/berlin/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findIstanbulTests(): Stream<Arguments> {
      return findTests("/certification/istanbul/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findFrontierTests(): Stream<Arguments> {
      return findTests("/certification/frontier/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findHomesteadTests(): Stream<Arguments> {
      return findTests("/certification/homestead/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findConstantinopleTests(): Stream<Arguments> {
      return findTests("/certification/constantinople/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findTangerineWhistleTests(): Stream<Arguments> {
      return findTests("/certification/tangerineWhistle/*.yaml")
    }

    @JvmStatic
    @Throws(IOException::class)
    private fun findSpuriousDragonTests(): Stream<Arguments> {
      return findTests("/certification/spuriousDragon/*.yaml")
    }
