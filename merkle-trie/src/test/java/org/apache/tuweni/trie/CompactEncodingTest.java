...
class CompactEncodingTest {
  ...
  void encodePath() {
    assertEquals(
        Bytes.of(0x11, 0x23, 0x45), CompactEncoding.encode(Bytes.of(0x01, 0x02, 0x03, 0x04, 0x05)));
    assertEquals(
    ...
    assertEquals(
        Bytes.of(0x3f, 0x1c, 0xb8),
        CompactEncoding.encode(Bytes.of(0x0f, 0x01, 0x0c, 0x0b, 0x08, 0x10)));
  }

  @Test
  void decode() {
    assertEquals(
        Bytes.of(0x01, 0x02, 0x03, 0x04, 0x05), CompactEncoding.decode(Bytes.of(0x11, 0x23, 0x45)));
    assertEquals(
    ...
    assertEquals(
        Bytes.of(0x0f, 0x01, 0x0c, 0x0b, 0x08, 0x10),
        CompactEncoding.decode(Bytes.of(0x3f, 0x1c, 0xb8)));
  }
}
