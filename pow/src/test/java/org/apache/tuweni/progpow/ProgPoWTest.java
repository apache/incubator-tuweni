...
class ProgPoWTest {
  ...
  void testProgPoWInit() {
    ...
    int[] expectedSrc =
        new int[] {
          0x1A, 0x1E, 0x01, 0x13, 0x0B, 0x15, 0x0F, 0x12, 0x03, 0x11, 0x1F, 0x10, 0x1C, 0x04, 0x16,
          0x17, 0x02, 0x0D, 0x1D, 0x18, 0x0A, 0x0C, 0x05, 0x14, 0x07, 0x08, 0x0E, 0x1B, 0x06, 0x19,
          0x09, 0x00
        };
    int[] expectedDest =
        new int[] {
          0x00, 0x04, 0x1B, 0x1A, 0x0D, 0x0F, 0x11, 0x07, 0x0E, 0x08, 0x09, 0x0C, 0x03, 0x0A, 0x01,
          0x0B, 0x06, 0x10, 0x1C, 0x1F, 0x02, 0x13, 0x1E, 0x16, 0x1D, 0x05, 0x18, 0x12, 0x19, 0x17,
          0x15, 0x14
        };
  ...
  public void progPowLoop() {
    ...
    UInt32[] cache = EthHash.mkCache(EthHash.getCacheSize(blockNumber), blockNumber);
    UInt32[] cDag =
        ProgPoW.createDagCache(blockNumber, (ind) -> EthHash.calcDatasetItem(cache, ind));

    ProgPoW.progPowLoop(
        blockNumber, UInt32.ZERO, mix, cDag, (ind) -> EthHash.calcDatasetItem(cache, ind));
  ...
  void testProgPoWHash() {
    ...
    assertEquals(
        Bytes32.fromHexString("5b7ccd472dbefdd95b895cac8ece67ff0deb5a6bd2ecc6e162383d00c3728ece"),
        digest);
  }
}
