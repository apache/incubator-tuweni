...
public interface SubProtocolIdentifier {
  ...
  /**
   * Provides the length of the range of message types supported by the subprotocol for a given
   * version
   *
   * @return the length of the range of message types supported by the subprotocol for a given
   *     version
   */
  int versionRange();
}
