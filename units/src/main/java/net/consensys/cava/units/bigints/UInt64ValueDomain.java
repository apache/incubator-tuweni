...
/**
 * A {@link DiscreteDomain} over a {@link UInt64Value}.
 */
public final class UInt64ValueDomain<T extends UInt64Value<T>> extends DiscreteDomain<T> {

  private final T minValue;
  private final T maxValue;

  /**
   * @param ctor The constructor for the {@link UInt64Value} type.
   */
  public UInt64ValueDomain(Function<UInt64, T> ctor) {
    this.minValue = ctor.apply(UInt64.MIN_VALUE);
    this.maxValue = ctor.apply(UInt64.MAX_VALUE);
  }
