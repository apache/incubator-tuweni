...
class BaseUInt256ValueTest {
  ...
  private static Stream<Arguments> addProvider() {
    return Stream.of(
        ...
        Arguments.of(hv("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE"), v(1), Value.MAX_VALUE));
  }
  ...
  private static Stream<Arguments> addUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(biv("13492324908428420834234908342"), UInt256.valueOf(10), biv("13492324908428420834234908352")),
        Arguments.of(
  ...
  private static Stream<Arguments> subtractProvider() {
    return Stream.of(
        ...
        Arguments.of(Value.MAX_VALUE, v(1), hv("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")));
  }
  ...
  private static Stream<Arguments> subtractUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(biv("13492324908428420834234908342"), UInt256.valueOf(10), biv("13492324908428420834234908332")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(23422141424214L),
  ...
  private static Stream<Arguments> multiplyUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(biv("13492324908428420834234908341"), UInt256.valueOf(2), biv("26984649816856841668469816682")),
        Arguments.of(biv("13492324908428420834234908342"), UInt256.valueOf(2), biv("26984649816856841668469816684")),
        ...
        Arguments.of(biv("13492324908428420834234908342"), UInt256.valueOf(8), biv("107938599267427366673879266736")),
        Arguments
            .of(biv("13492324908428420834234908342"), UInt256.valueOf(2048), biv("27632281412461405868513092284416")),
        Arguments.of(
            biv("13492324908428420834234908342"),
  ...
  private static Stream<Arguments> divideUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(biv("13492324908428420834234908342"), UInt256.valueOf(131072), biv("102938269870211950944785")));
  }
