...
class BaseUInt256ValueTest {
  ...
  private static Stream<Arguments> addUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(10),
            biv("13492324908428420834234908352")),
        Arguments.of(
            biv("13492324908428420834234908342"),
  ...
  private static Stream<Arguments> addModProvider() {
    return Stream.of(
        ...
        Arguments.of(
            Value.MAX_VALUE.subtract(2), v(1), UInt256.MAX_VALUE, Value.MAX_VALUE.subtract(1)),
  ...
  private static Stream<Arguments> addModUInt256UInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            Value.MAX_VALUE.subtract(2),
            UInt256.ONE,
            UInt256.MAX_VALUE,
            Value.MAX_VALUE.subtract(1)),
  ...
  private static Stream<Arguments> addModLongUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            Value.MAX_VALUE.subtract(2), 1L, UInt256.MAX_VALUE, Value.MAX_VALUE.subtract(1)),
  ...
  private static Stream<Arguments> subtractUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(10),
            biv("13492324908428420834234908332")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(23422141424214L),
            biv("13492324908428397412093484128")),
  ...
  private static Stream<Arguments> multiplyUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            biv("13492324908428420834234908341"),
            UInt256.valueOf(2),
            biv("26984649816856841668469816682")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(2),
            biv("26984649816856841668469816684")),
        ...
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(8),
            biv("107938599267427366673879266736")),
        Arguments.of(
            biv("13492324908428420834234908342"),
  ...
  void shouldThrowForMultiplyModUInt256UInt256OfModZero() {
    Throwable exception =
        assertThrows(
            ArithmeticException.class, () -> v(0).multiplyMod(UInt256.valueOf(5), UInt256.ZERO));
    assertEquals("multiplyMod with zero modulus", exception.getMessage());
  }
  ...
  void shouldThrowForMultiplyModLongUInt256OfModZero() {
    Throwable exception =
        assertThrows(ArithmeticException.class, () -> v(3).multiplyMod(1L, UInt256.ZERO));
    assertEquals("multiplyMod with zero modulus", exception.getMessage());
  }
  ...
  void shouldThrowForMultiplyModLongUInt256OfNegative() {
    Throwable exception =
        assertThrows(ArithmeticException.class, () -> v(5).multiplyMod(-1, UInt256.valueOf(2)));
  ...
  private static Stream<Arguments> divideUInt256Provider() {
    return Stream.of(
        ...
        Arguments.of(
            biv("13492324908428420834234908341"),
            UInt256.valueOf(2),
            biv("6746162454214210417117454170")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(2),
            biv("6746162454214210417117454171")),
        Arguments.of(
            biv("13492324908428420834234908343"),
            UInt256.valueOf(2),
            biv("6746162454214210417117454171")),
        ...
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(8),
            biv("1686540613553552604279363542")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(2048),
            biv("6588049271693564860466263")),
        Arguments.of(
            biv("13492324908428420834234908342"),
            UInt256.valueOf(131072),
            biv("102938269870211950944785")));
  }
  ...
  private static Stream<Arguments> addExactProvider() {
    return Stream.of(
        Arguments.of(Value.MAX_VALUE, v(1)), Arguments.of(Value.MAX_VALUE, Value.MAX_VALUE));
  }
  ...
  private static Stream<Arguments> addExactLongProvider() {
    return Stream.of(
        Arguments.of(Value.MAX_VALUE, 3),
        Arguments.of(Value.MAX_VALUE, Long.MAX_VALUE),
        Arguments.of(v(0), -1));
  }
  ...
  private static Stream<Arguments> subtractExactLongProvider() {
    return Stream.of(
        ...
        Arguments.of(Value.MAX_VALUE, -1));
  }
