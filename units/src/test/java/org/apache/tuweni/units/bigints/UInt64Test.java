...
class UInt64Test {
  ...
  void valueOfBigInteger() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> UInt64.valueOf(BigInteger.valueOf(2).pow(64)));
  }
  ...
  private static Stream<Arguments> addModProvider() {
    return Stream.of(
        ...
        Arguments.of(
            UInt64.MAX_VALUE.subtract(2), v(1), UInt64.MAX_VALUE, UInt64.MAX_VALUE.subtract(1)),
  ...
  private static Stream<Arguments> addModLongUInt64Provider() {
    return Stream.of(
        ...
        Arguments.of(
            UInt64.MAX_VALUE.subtract(2), 1L, UInt64.MAX_VALUE, UInt64.MAX_VALUE.subtract(1)),
  ...
  void shouldThrowForMultiplyModLongUInt64OfModZero() {
    Throwable exception =
        assertThrows(ArithmeticException.class, () -> v(5).multiplyMod(1L, UInt64.ZERO));
    assertEquals("multiplyMod with zero modulus", exception.getMessage());
  }
  ...
  void shouldThrowForMultiplyModLongUInt64OfNegative() {
    Throwable exception =
        assertThrows(ArithmeticException.class, () -> v(3).multiplyMod(-1, UInt64.valueOf(2)));
  ...
  private static Stream<Arguments> addExactProvider() {
    return Stream.of(
        Arguments.of(UInt64.MAX_VALUE, v(1)), Arguments.of(UInt64.MAX_VALUE, UInt64.MAX_VALUE));
  }
  ...
  private static Stream<Arguments> addExactLongProvider() {
    return Stream.of(
        Arguments.of(UInt64.MAX_VALUE, 3),
        Arguments.of(UInt64.MAX_VALUE, Long.MAX_VALUE),
        Arguments.of(v(0), -1));
  }
  ...
  private static Stream<Arguments> subtractExactLongProvider() {
    return Stream.of(
        ...
        Arguments.of(UInt64.MAX_VALUE, -1));
  }
